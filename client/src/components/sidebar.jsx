...
export default function Sidebar() {
  const {users, getUsers, selectedUser, setSelectedUser, isUsersLoading} = chatStore();
  ...
  const filterOnlineUsers = showOnlineOnly ? users.filter(user=>onlineUsers.includes(user._id)) : users;
